...
import { ChevronLeft, Clock, CheckCircle2, ArrowRight, PlayCircle, SkipForward, Check } from 'lucide-react';
                    ...
                    <div className="space-y-3">
                      {activeSubQuestion.mcqAnswer?.options.map((opt: any) => {
                        ...
                        if (isMulti) {
                          ...
                          isSelected = String(currentAnswer) === String(opt.id);
                        }
                            ...
                            onClick={() => {
                              if (isMulti) {
                                ...
                                const newVal = isSelected
                                  ? curr.filter((id: string) => String(id) !== String(opt.id))
                                  : [...curr, opt.id];
