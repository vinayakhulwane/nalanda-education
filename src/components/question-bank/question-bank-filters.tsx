    ...
    <div className="mb-6 space-y-4">
      <div className="flex flex-wrap items-center gap-2 rounded-lg border p-4">
        <Select value={filters.unit} onValueChange={setFilters.setUnit}>
          <SelectTrigger className="w-full sm:w-[180px]"><SelectValue placeholder="Filter by Unit..." /></SelectTrigger>
          <SelectContent>
        ...
        <Select value={filters.currency} onValueChange={setFilters.setCurrency}>
          <SelectTrigger className="w-full sm:w-[180px]"><SelectValue placeholder="Filter by Currency..." /></SelectTrigger>
          <SelectContent>
       ...
       <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            {activeFilters.map(f => (
                <span key={f.key} className="flex items-center gap-1 bg-muted px-2 py-1 rounded-md">
                    {f.label}
