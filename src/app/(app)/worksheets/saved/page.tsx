                        ...
                        <TableBody>
                            {subjectWorksheets.map(ws => (
                                <TableRow key={ws.id}>
                                    ...
                                    <TableCell className="text-center">{ws.questions.length}</TableCell>
                                    <TableCell>
                                    ...
                                    <TableCell className="text-right">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem onClick={() => handleDeleteWorksheet(ws.id)} className="text-destructive focus:text-destructive">
